  ...
  return (
    <div className="container mx-auto py-10 px-4">
      <div className="text-center max-w-3xl mx-auto">
        <Palette className="h-12 w-12 mx-auto text-brand-violet" />
      ...
      <div className="mt-12 prose dark:prose-invert mx-auto">
        ...
        <h3>Key Services:</h3>
        <ul>
          <li><CheckCircle className="inline-block h-4 w-4 mr-2 text-success" />Brand Strategy & Positioning</li>
          <li><CheckCircle className="inline-block h-4 w-4 mr-2 text-success" />Logo Design & Visual Identity</li>
          <li><CheckCircle className="inline-block h-4 w-4 mr-2 text-success" />Brand Guidelines Development</li>
          <li><CheckCircle className="inline-block h-4 w-4 mr-2 text-success" />Messaging & Tone of Voice</li>
          <li><CheckCircle className="inline-block h-4 w-4 mr-2 text-success" />Marketing Collateral Design</li>
          <li><CheckCircle className="inline-block h-4 w-4 mr-2 text-success" />Brand Audits & Revitalization</li>
        </ul>
        <p>
